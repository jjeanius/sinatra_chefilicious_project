...
class MealkitsController < ApplicationController
  ...
  patch '/mealkits/:id' do   #  needs to match action of form submitted for get mealkits/edit
    #binding.pry
  ...
  #  @mealkit.update(:mealkit =>params[:mealkit])
     @mealkit.update(ingredients: params[:mealkit][:ingredients], time: params[:mealkit][:time], serving_size: params[:mealkit][:size])
     @mealkit.save
